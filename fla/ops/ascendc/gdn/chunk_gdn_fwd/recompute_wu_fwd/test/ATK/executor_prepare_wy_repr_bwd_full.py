...
@register("executor_recompute_wu_fwd")
class FunctionApi(BaseApi):
    ...
    def __call__(self, input_data: InputDataset, with_output: bool = False):
        ...
        dv = recompute_wu_fwd_torch(q, k, d_o, g, scale, cu_seqlens, chunk_size)
...
# @register("aclnn_recompute_wu_fwd")
